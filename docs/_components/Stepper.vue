<template>
    <section class="olt-stepper">
        <div class="olt-stepper__header">
            <div class="olt-stepper__step-item" :class="{'olt-stepper__step-item--is-active': activeIndex === 0}" @click="activeIndex = 0">
                <div class="olt-stepper__step-item-inner">
                    <div class="olt-fab olt-fab--paginator">1</div>
                    <span>Step</span>
                </div>
            </div>
            <div class="olt-stepper__step-item" :class="{'olt-stepper__step-item--is-active': activeIndex === 1}" @click="activeIndex = 1">
                <div class="olt-stepper__step-item-inner">
                    <div class="olt-fab olt-fab--paginator">2</div>
                    <span>Step</span>
                </div>
            </div>
            <div class="olt-stepper__step-item" :class="{'olt-stepper__step-item--is-active': activeIndex === 2}" @click="activeIndex = 2">
                <div class="olt-stepper__step-item-inner">
...
export default {
    ...
    mounted() {
        const elements = this.$el.querySelectorAll('.olt-stepper__step-item');
