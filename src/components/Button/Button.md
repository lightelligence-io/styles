...
```icon.html
<a class="olt-Button olt-Button--icon olt-Icon-navigation-close"></a>
<a class="olt-Button olt-Button--outline olt-Button--icon olt-Icon-navigation-close"></a>
<button class="olt-Button olt-Button--primary olt-Button--icon olt-Icon-navigation-close"></button>
<button class="olt-Button olt-Button--primary olt-Button--outline olt-Button--icon olt-Icon-navigation-close"></button>
```
