  ...
  <div class="olt-u-marginAuto">
    ...
    <div class="olt-V2Modal">
      <div class="olt-V2Modal-dialog">
        <label class="olt-V2Modal-close" for="modal-demo-1"></label>
        <header class="olt-V2Modal-header">
          <h5 class="olt-V2Modal-title Headline Headline--5">This is a modal</h5>
        </header>
...
<div class="olt-V2Modal">
  <div class="olt-V2Modal-dialog">
    <label class="olt-V2Modal-close" for="modal-toggle-1"></label>
    <header class="olt-V2Modal-header">
      <h5 class="olt-V2Modal-title Headline Headline--5">This is a modal</h5>
    </header>
    <div class="olt-V2Modal-content">
...
<div class="olt-Card olt-u-padding5">
  <div class="olt-u-marginAuto">
    ...
    <div class="olt-V2Modal olt-V2Modal--error">
      <div class="olt-V2Modal-dialog">
        <label class="olt-V2Modal-close" for="modal-demo-2"></label>
        <header class="olt-V2Modal-header">
          <h5 class="olt-V2Modal-title olt-Headline olt-Headline--5">Oh no! An error occurred</h5>
        </header>
        <div class="olt-V2Modal-content">
          <p>You should really check the configuration</p>
        </div>
...
<div class="olt-V2Modal olt-V2Modal--error">
  <div class="olt-V2Modal-dialog">
    <label class="olt-V2Modal-close" for="modal-toggle-2"></label>
    <header class="olt-V2Modal-header">
      <h5 class="olt-V2Modal-title olt-Headline olt-Headline--5">Oh no! An error occurred</h5>
    </header>
    <div class="olt-V2Modal-content">
...
<div class="olt-Card olt-u-padding5">
  <div class="olt-u-marginAuto">
    ...
    <div class="olt-V2Modal olt-V2Modal--warning">
      <div class="olt-V2Modal-dialog">
        <label class="olt-V2Modal-close" for="modal-demo-3"></label>
        <div class="olt-V2Modal-content">
          <h5 class="olt-V2Modal-title Headline Headline--5">Attention! Here's a warning for you</h5>
...
<div class="olt-V2Modal olt-V2Modal--warning">
  <div class="olt-V2Modal-dialog">
    <label class="olt-V2Modal-close" for="modal-toggle-3"></label>
    <div class="olt-V2Modal-content">
      <h5 class="olt-V2Modal-title Headline Headline--5">Attention! Here's a warning for you</h5>
      <p>We detected a problem in your configuration</p>
    </div>
...
<div class="olt-Card olt-u-padding5">
  <div class="olt-u-marginAuto">
    ...
    <div class="olt-V2Modal olt-V2Modal--info">
      <div class="olt-V2Modal-dialog">
        <label class="olt-V2Modal-close" for="modal-demo-4"></label>
        <div class="olt-V2Modal-content">
          <h5 class="olt-V2Modal-title Headline Headline--5">Oh! Here's some info for you</h5>
          <p>You should really check the configuration</p>
        </div>
        <div class="olt-V2Modal-footer">
...
<div class="olt-V2Modal olt-V2Modal--info">
  <div class="olt-V2Modal-dialog">
    <label class="olt-V2Modal-close" for="modal-toggle-4"></label>
    <div class="olt-V2Modal-content">
      <h5 class="olt-V2Modal-title Headline Headline--5">Oh! Here's some info for you</h5>
      <p>You should really check the configuration</p>
    </div>
...
<div class="olt-Card olt-u-padding5">
  <div class="olt-u-marginAuto">
    ...
    <div class="olt-V2Modal olt-V2Modal--success">
      <div class="olt-V2Modal-dialog">
        <label class="olt-V2Modal-close" for="modal-demo-5"></label>
        <header class="olt-V2Modal-header">
          <h5 class="olt-V2Modal-title olt-Headline olt-Headline--5">Oh yes! Success occurred</h5>
        </header>
        <div class="olt-V2Modal-content">
...
<div class="olt-V2Modal olt-V2Modal--success">
  <div class="olt-V2Modal-dialog">
    <label class="olt-V2Modal-close" for="modal-toggle-5"></label>
    <header class="olt-V2Modal-header">
      <h5 class="olt-V2Modal-title olt-Headline olt-Headline--5">Oh yes! Success occurred</h5>
    </header>
    <div class="olt-V2Modal-content">
...
There is an additional fullscreen *V2Modal* which takes the space of the whole
screen when rendered. This *V2Modal* can be used for various wizards in a
...
<div class="olt-Card olt-u-padding5">
  <div class="olt-u-marginAuto">
    <input data-toggle="modal" id="demo-5" type="checkbox">
    <label class="olt-Button" for="modal-demo-5">Open</label>
    <div class="olt-V2Modal olt-V2Modal--fullscreen olt-V2Modal--error">
      <div class="olt-V2Modal-dialog">
        <div class="olt-Container">
          <header class="olt-V2Modal-header">
            <h2 class="olt-V2Modal-title olt-Headline olt-Headline--2">Tenant registration</h2>
          </header>
          <div class="olt-V2Modal-content">
