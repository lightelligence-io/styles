...
<div class="olt-Checkbox">
  ...
  <label for="my-checkbox" class="olt-Label olt-Checkbox-label">Checkbox</label>
</div>
<div class="olt-Checkbox">
  <input id="checked-checkbox" type="checkbox" class="olt-Checkbox-input" checked/>
  <label for="disabled-checkbox" class="olt-Label olt-Checkbox-label">Checked checkbox</label>
</div>
<div class="olt-Checkbox">
...
<div class="olt-Checkbox">
  ...
  <label for="disabled-checkbox" class="olt-Label olt-Checkbox-label">Disabled checked checkbox</label>
</div>
```
